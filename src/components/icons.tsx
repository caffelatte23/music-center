...
export const IconNowPlaying = (props: IconProps) => (
  <svg {...defaultProps(props)}>
    ...
    <polygon points="10 8 16 12 10 16 10 8" fill={props.color ?? "currentColor"} stroke="none" />
  </svg>
);
...
export const IconPlaylist = (props: IconProps) => (
  <svg {...defaultProps(props)}>
    ...
    <circle cx="3" cy="6" r="1.5" fill={props.color ?? "currentColor"} stroke="none" />
    <circle cx="3" cy="12" r="1.5" fill={props.color ?? "currentColor"} stroke="none" />
    <circle cx="3" cy="18" r="1.5" fill={props.color ?? "currentColor"} stroke="none" />
  </svg>
);
...
export const IconPlay = (props: IconProps) => (
  <svg {...defaultProps(props)} fill={props.color ?? "currentColor"} stroke="none">
...
export const IconAppLogo = ({ size = 16, color = "white", style, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
